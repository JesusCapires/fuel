        ...
        <div class="header-content-right">
            ...
            <div class="header-element">
                ...
                <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <div class="me-sm-2 me-0">
                            <img src="./../assets/images/faces/21.jpg" alt="img" width="32" height="32" class="rounded-circle">
                        </div>
                        <div class="d-sm-block d-none">
                            <p class="fw-semibold mb-0 lh-1 text-white">Jesus Capires</p>
                            <span class="fw-semibold d-block fs-11 text-white">Programador jr</span>
                        </div>
                    </div>
                </a>
                <!-- End::header-link|dropdown-toggle -->
                <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                    ...
                    <li><a class="dropdown-item d-flex" href="" ><i class="ti ti-logout fs-18 me-2 op-7"></i>Cerrar sesión</a></li>
                </ul>
            </div>
            <!-- End::header-element -->
        </div>
